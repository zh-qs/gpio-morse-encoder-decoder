...
const struct morse_search_tree thole = {'\0', &thole, &thole};

const struct morse_search_tree t5 = {'5', &thole, &thole},
...
const struct morse_search_tree tdj = {'\0', &tqm, &tund}, tee = {'\0', &tdq, &thole},
...
const struct morse_search_tree th = {'H', &t5, &t4}, tv = {'V', &thole, &t3},
...
const struct morse_search_tree ts = {'S', &th, &tv}, tu = {'U', &tf, &tuuml},
    tr = {'R', &tl, &tauml}, tw = {'W', &tp, &tj}, td = {'D', &tb, &tx},
    tk = {'K', &tc, &ty}, tg = {'G', &tz, &tq}, to = {'O', &touml, &tch};

const struct morse_search_tree ti = {'I', &ts, &tu}, ta = {'A', &tr, &tw},
    tn = {'N', &td, &tk}, tm = {'M', &tg, &to};

const struct morse_search_tree te = {'E', &ti, &ta}, tt = {'T', &tn, &tm};

const struct morse_search_tree morse_tree = {'\0', &te, &tt};